...
const MessageArea = (props) => {
    ...
    <div className="MessageArea">
        ...
        <textarea
            ...
            rows = "6"
        />
        <p>After typing the message, you can hit send. <strong>OPTIONAL:</strong> If you type a WhatsApp number in the box below, you can directly send the message to someone even if you haven't saved their number. <strong>Don't forget the country code!</strong> (Preceding '+' can be ignored)</p>
        <input
                className="NumberBox"
                type="number"
